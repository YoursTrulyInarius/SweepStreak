...
('First Clean', 'Complete your first cleaning task', '⭐'),
('Streak Master', 'Maintain a 7-day cleaning streak', '🔥'),
('Perfect Week', 'Complete all tasks for a week', '🏆'),
('Team Player', 'Complete tasks with full group attendance', '👥'),
('Early Bird', 'Submit cleaning task before 8 AM', '🌅');

-- Update badges to use emojis
UPDATE badges SET icon = '⭐' WHERE name = 'First Clean';
UPDATE badges SET icon = '🔥' WHERE name = 'Streak Master';
UPDATE badges SET icon = '🏆' WHERE name = 'Perfect Week';
UPDATE badges SET icon = '👥' WHERE name = 'Team Player';
UPDATE badges SET icon = '🌅' WHERE name = 'Early Bird';
